...
class HeroinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create heroine" do
    assert_difference('Heroine.count') do
      post heroines_url, params: { heroine: { name: @heroine.name, super_name: @heroine.super_name } }
    end
  ...
  test "should update heroine" do
    patch heroine_url(@heroine), params: { heroine: { name: @heroine.name, super_name: @heroine.super_name } }
